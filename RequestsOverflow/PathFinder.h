...
/*FIND*/
void ThreadPathFinder(std::vector<std::vector<GameBlock>> *prmPtrBoard,uint prmStartPosX,uint prmStartPosY,uint prmFindMode,std::vector<std::vector<int>>* prmPtrOutputPath,bool *prmThreadRunning,bool *prmPathLock);//Gestion du thread du pathfinding
